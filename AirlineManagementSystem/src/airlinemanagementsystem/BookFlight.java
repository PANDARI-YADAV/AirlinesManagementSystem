      ...
      String dest = destination.getSelectedItem();
       ...
       try{
          ...
          String ddate=((JTextField)dcdate.getDateEditor().getUiComponent()).getText();
           ...
           String query = "insert into reservation values('PNR-"+s+"','TIC-"+random.nextInt(10000)+"','"+aadhar+"','"+name+"','"+nationality+"','"+flightname+"','"+flightcode+"','"+src+"','"+des+"','"+ddate+"')";
           
           conn.s.executeUpdate(query);
           
           
               JOptionPane.showMessageDialog(null,"Ticket Booked Succesfully Your PNR-"+ s);
